...
<button type="submit" className="btn btn-primary">Please enter your valid email Id</button>
    </div>
    <input type="password" className="form-control mb-3" id="password" placeholder="Password" />
    <div className="text-center">
<button type="submit" className="btn btn-primary">Enter Password</button>
    </div>
  </form>
  <p className="text-center mt-3"><Link to="/">Login</Link></p>
            </div>
          </div>
          <div className="col-sm-4"></div>
        </div>
